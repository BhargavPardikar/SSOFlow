...
class CreatePolicy{
    ...
    makepolicy () {
        ...
        cy.get(AddPolicy.selectgroup).click({ force: true }).type('Group1{enter}', { delay: 100 }).click({ force: true });
        cy.wait(2000);
         //Group1 is created here! Enter your group name or else DEFAULT
